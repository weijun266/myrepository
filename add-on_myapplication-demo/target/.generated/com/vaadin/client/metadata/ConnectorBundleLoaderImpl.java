      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setSuperClass(com.example.add_on_myapplication.client.MyComponentState.class, com.vaadin.shared.AbstractComponentState.class);
            ...
            store.setClass("com.example.add_on_myapplication.MyComponent", com.example.add_on_myapplication.client.MyComponentConnector.class);
            ...
            store.setConstructor(com.example.add_on_myapplication.client.MyComponentConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.example.add_on_myapplication.client.MyComponentConnector.class);
              }
            });
            store.setConstructor(com.example.add_on_myapplication.client.MyComponentState.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.example.add_on_myapplication.client.MyComponentState.class);
              }
            });
            store.setConstructor(com.example.add_on_myapplication.client.MyComponentWidget.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.example.add_on_myapplication.client.MyComponentWidget.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(com.example.add_on_myapplication.client.MyComponentConnector.class, "getState", new Type(com.example.add_on_myapplication.client.MyComponentState.class));
            store.setReturnType(com.example.add_on_myapplication.client.MyComponentConnector.class, "getWidget", new Type(com.example.add_on_myapplication.client.MyComponentWidget.class));
            load2();
          }
          private void load2() {
            ...
            store.setInvoker(com.example.add_on_myapplication.client.MyComponentClientRpc.class, "alert",new Invoker() {
              public Object invoke(Object target, Object[] params) {
                ((com.example.add_on_myapplication.client.MyComponentClientRpc) target).alert((java.lang.String) params[0]);
                return null;
              }
            });
          ...
          private void load4() {
            ...
            store.setParamTypes(com.example.add_on_myapplication.client.MyComponentClientRpc.class, "alert", new Type[] {new Type(java.lang.String.class), });
            store.setParamTypes(com.example.add_on_myapplication.client.MyComponentServerRpc.class, "clicked", new Type[] {new Type(com.vaadin.shared.MouseEventDetails.class), });
            ...
            store.setProxyHandler(com.example.add_on_myapplication.client.MyComponentServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new com.example.add_on_myapplication.client.MyComponentServerRpc() {
                  public void clicked(com.vaadin.shared.MouseEventDetails p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.example.add_on_myapplication.client.MyComponentServerRpc.class).getMethod("clicked"), new Object [] {p0, });
                  }
                };
              }
            });
          ...
          private void load7() {
            ...
            store.setPropertyType(com.example.add_on_myapplication.client.MyComponentState.class, "text", new Type(java.lang.String.class));
          ...
          private void load8() {
            ...
            store.addOnStateChangeMethod(com.example.add_on_myapplication.client.MyComponentConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "handleContextClickListenerChange", new String[] {"registeredEventListeners", }));
          ...
          private native void loadNativeJs3(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.example.add_on_myapplication.client.MyComponentState::text = value;
              },
              getter: function(bean) {
                return bean.@com.example.add_on_myapplication.client.MyComponentState::text;
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.example.add_on_myapplication.client.MyComponentState::class, 'text', data);
